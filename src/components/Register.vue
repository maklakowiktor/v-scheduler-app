                    ...
                    <v-container>
                      ...
                      <v-row>
                        <v-col cols="12" sm="6" md="6">
                          <v-text-field label="Фамилия" name="surname" type="text" v-model="surname" :rules="personRules" required
                          ></v-text-field>
                          <v-text-field label="Отчество" name="patronymic" type="text" v-model="patronymic" :rules="personRules" required
                          ></v-text-field>
                        </v-col>
                        <v-col cols="12" sm="6" md="6">
                          <v-text-field label="Имя" name="name" type="text" v-model="name" :rules="personRules" required
                          ></v-text-field>
                          <v-text-field label="Должность" name="position" type="text" v-model="position" :rules="personRules" required
                          ></v-text-field>
                        </v-col>
                        <v-col cols="12" sm="6" md="6">
                          <v-text-field label="E-mail" name="login" prepend-icon="person" type="text" v-model="email" :rules="emailRules" required
                        ></v-text-field>
                          <v-text-field label="Секретный ключ" name="secretkey" prepend-icon="mdi-key-variant" type="text" v-model="secretkey" :rules="compareKey" required
                          ></v-text-field>
                        </v-col>
                        <v-col cols="12" sm="6" md="6">
